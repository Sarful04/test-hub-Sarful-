...
import 'package:test_hub/shared/widgets/textFormField.dart';
...
class _RegisterPageState extends State<RegisterPage> {
  ...
  TextEditingController regiterEmail = TextEditingController();
  TextEditingController regiterPassword = TextEditingController();
                ...
                children: [
                  ...
                  Padding(
                      ...
                      child: CommonTextField(
                        ...
                        formFieldIcon: Icons.lock,
                        isSuffix: true,
                        passToggle: false,
                      )),
                  // TextFormField(
                  //   controller: regiterEmail,
                  //   decoration: const InputDecoration(
                  //       labelText: 'Email',
                  //       enabledBorder: OutlineInputBorder(
                  //         borderSide: BorderSide(color: Colors.black),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      style: ElevatedButton.styleFrom(
                          backgroundColor:
                              const Color.fromARGB(255, 24, 248, 229)),
                      onPressed: validate,
                      child: const Text(
                        "Sign in",
                        style: TextStyle(
